...
\title{Heuristische Evaluierung nach Nielsen-praktische Anwendung im Studium }
...
\author{%
  \alignauthor{%
    \textbf{Fisnik Beqiri}\\
    \affaddr{FH Joanneum} \\
    \affaddr{Alte Poststraße 149, 8020 Graz} \\
    \email{fisnik.beqiri@edu.fh-joanneum.at} }\alignauthor{%
    \textbf{Fifth Author}\\
    \affaddr{YetAuthorCo, Inc.}\\
    \affaddr{Authortown, BC V6M 22P Canada}\\
    \email{ulrike.ozim@edu.fh-joanneum.at} } \vfil \alignauthor{%
    \textbf{Ulrike Ozim}\\
    \affaddr{FH Joanneum}\\
    \affaddr{Authorship Holdings, Ltd.}\\
    \affaddr{Alte Poststraße 149, 8020 Graz}\\
    \email{ulrike.ozim@edu.fh-joanneum.at} }\alignauthor{%
    \textbf{Sixth Author}\\
    ...
    \affaddr{Alte Poststraße 149, 8020 Graz}\\
    \email{lukas.weber@edu.fh-joanneum.at} \\
